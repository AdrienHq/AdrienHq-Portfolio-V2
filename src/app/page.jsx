...
const Homepage = () => {
    return <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
      ...
      <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-8 items-center justify-center">
          <h1 className="text-4xl md:text-6xl font-bold">My Description</h1>
          <p className="md:text-xl">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores beatae error odit quisquam, temporibus voluptates.</p>
